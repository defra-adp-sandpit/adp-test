...
using Adp.Test.Api.AutoMapper;
using Adp.Test.Api.Config;
using Adp.Test.Api.Extensions;
using Adp.Test.Api.HealthChecks;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Adp.Test", Version = "v1" });
        });
